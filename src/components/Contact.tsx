      ...
      <div className="mx-auto max-w-7xl">
        <div className="contact-content flex flex-col items-center text-center">
          ...
          <div className="flex flex-col gap-6 mb-20">
            ...
            >
              <Mail className="h-6 w-6" suppressHydrationWarning />
          ...
          >
            GitHub Profile <ArrowRight className="h-4 w-4" suppressHydrationWarning />
          </a>
          

          <div className="mt-32 w-full border-t border-white/5 pt-12 text-sm text-secondary/40">
            <p>© 2026 Anubhav's Portfolio. All rights reserved.</p>
          </div>
        </div>
      </div>
    </section>
